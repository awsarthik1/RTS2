...
sed -i -e 's/"//g' -e 's/"//g' -e 's/{//g' -e 's/\\//g' -e 's/~/\n/g' -e 's/,/\n/g' -e 's/SenderId:AIDAIT2UOQQY3AUEKVGXU/RequestId: 4c0d058b-e9f1-565e-9a98-5c04ef81d2e3/g' -e 's/Md5OfMessageAttributes:null/###############################/g' 3test1a.html
...
log_filter () {
	...
	grep -i 'RequestId:\|Message : nagios\|Host:\|Host_State:\|Service:\|Address:\|Service_State:\|Date/Time:\|Status Info:\|Timestamp :\|AlarmName:\|AQentelli@Rts2021larmDescription:\|AWSAccountId:\|NewStateValue:\|NewStateReason:\|StateChangeTime:\|ComparisonOperator:\|Threshold:\|Dimensions:\|##' 3test1a.html
}



log_filter > /home/qentellirts/experiment/filtered_logs1
